...
Started](http://docs.jimbrig.com/freestiler/articles/getting-started.md)
...
Read the [mapping
vignette](http://docs.jimbrig.com/freestiler/articles/mapping.md) to
learn more.
...
| File input | [`freestile_file()`](http://docs.jimbrig.com/freestiler/reference/freestile_file.md) | [`freestile_file()`](http://docs.jimbrig.com/freestiler/reference/freestile_file.md) |
| DuckDB queries | [`freestile_query()`](http://docs.jimbrig.com/freestiler/reference/freestile_query.md) | [`freestile_query()`](http://docs.jimbrig.com/freestiler/reference/freestile_query.md) |
