...
The package supports two tile formats: [MapLibre Tiles (MLT)](https://github.com/maplibre/maplibre-tile-spec), a next-generation columnar format that's the default, and Mapbox Vector Tiles (MVT), the widely-supported protobuf format. See the [MapLibre Tiles](maplibre-tiles.html) article for more on the differences.
